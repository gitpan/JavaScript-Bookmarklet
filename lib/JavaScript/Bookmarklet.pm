...
A "bookmarklet" is a little JavaScript script thatÕs
intended to be run from a web browserÕs bookmarks bar or
...
Fireball fame wrote that makes writing Ñ- and especially
revising Ñ- JavaScript bookmarklets much more pleasant.
